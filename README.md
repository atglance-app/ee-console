...
AtGlance is a self‑hosted operations platform that connects an Ubuntu‑focused CLI agent with a central management console to make service operations safer, traceable, and easier to automate for engineering teams.[memory:2]
...
The AtGlance Management Console is a Laravel + Kong + MySQL + Redis stack that organizations deploy inside their own network boundary.[memory:2] It provides:
